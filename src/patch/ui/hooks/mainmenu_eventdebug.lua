if _mpPatch and _mpPatch.canEnable then
    _mpPatch.eventList = {
        ...
        "MinimapClickedEvent", "MinimapTextureBroadcastEvent", "MultiplayerConnectionFailed",
        "MultiplayerGameAbandoned", "MultiplayerGameInvite", "MultiplayerGameLaunched", "MultiplayerGameListClear",
        "MultiplayerGameListComplete", "MultiplayerGamePlayerDisconnected", "MultiplayerGamePlayerUpdated",
        "MultiplayerJoinRoomComplete", "MultiplayerJoinRoomFailed", "MultiplayerPingTimesChanged",
        "NaturalWonderRevealed", "NotificationAdded", "NotificationRemoved", "OpenInfoCorner",
        "OpenPlayerDealScreenEvent", "ParticleEffectReloadRequested", "ParticleEffectStatsRequested",
        "ParticleEffectStatsResponse", "PlayerChoseToLoadGame", "PlayerVersionMismatchEvent", "PreGameDirty",
        "RemotePlayerTurnEnd", "RemoveAllArrowsEvent", "RequestYieldDisplay", "RunCombatSim", "SearchForPediaEntry",
        "SequenceGameInitComplete", "SerialEventBuildingSizeChanged", "SerialEventCameraIn", "SerialEventCameraOut",
        "SerialEventCameraStartMovingBack", "SerialEventCameraStartMovingForward", "SerialEventCameraStartMovingLeft",
        "SerialEventCameraStartMovingRight", "SerialEventCameraStopMovingBack", "SerialEventCameraStopMovingForward",
        "SerialEventCameraStopMovingLeft", "SerialEventCameraStopMovingRight", "SerialEventCityCaptured",
        "SerialEventCityContinentChanged", "SerialEventCityCreated", "SerialEventCityCultureChanged",
        "SerialEventCityDestroyed", "SerialEventCityHexHighlightDirty", "SerialEventCityInfoDirty",
        "SerialEventCityPopulationChanged", "SerialEventCityScreenDirty", "SerialEventCitySetDamage",
        "SerialEventDawnOfManHide", "SerialEventDawnOfManShow", "SerialEventEndTurnDirty",
        "SerialEventEnterCityScreen", "SerialEventEraChanged", "SerialEventEspionageScreenDirty",
        ...
        "UnitMemberCombatTargetChanged", "UnitMemberOverlayAdd", "UnitMemberOverlayRemove",
        "UnitMemberOverlayShowHide", "UnitMemberPositionChanged", "UnitMoveQueueChanged", "UnitSelectionChanged",
        "UnitSelectionCleared", "UnitShouldDimFlag", "UnitStateChangeDetected", "UnitTypeChanged",
        "UnitVisibilityChanged", "UserRequestClose", "WarStateChanged", "WorldMouseOver",
    }
